...
const comprehensiveIdSchema = JSON.parse(
  fs.readFileSync('./schemas/json/ComprehensiveIdCredential.json', 'utf-8')
);

function generateComprehensiveIDCredential(
  callback?: (data: any) => void
): any {
  const data = jsf.generate(comprehensiveIdSchema) as any;
  ...
  data['@context'] =
    'https://raw.githubusercontent.com/redbellynetwork/receptor-schema/refs/heads/main/schemas/json-ld/ComprehensiveIdCredential.jsonld';
  data.id = faker.string.uuid();
  data.type = ['VerifiableCredential', 'ComprehensiveIdCredential'];
  ...
  data.credentialSchema = {
    id: 'https://raw.githubusercontent.com/redbellynetwork/receptor-schema/refs/heads/main/schemas/json/ComprehensiveIdCredential.json',
...
export const comprehensiveTestScenarios = [
  {
    name: 'Valid Comprehensive ID',
    data: generateComprehensiveIDCredential(),
    expectedValid: true,
  },
  {
    name: 'Missing Required Field',
    data: generateComprehensiveIDCredential((data) => {
